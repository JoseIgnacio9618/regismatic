...
export class ApiService {
  ...
  private readonly backendErrorMap: Record<string, string> = {
    ...
    "Administrators can only change employee passwords.": "errors.admin_password_employee_only",
    "Only superadministrators can change user passwords.": "errors.superadmin_password_only",
    "Superadministrator passwords cannot be changed from this screen.": "errors.superadmin_password_target_invalid",
    "Only superadministrators can start a session as another user.": "errors.superadmin_impersonation_only",
    "You can only start a session as administrators or employees.": "errors.superadmin_impersonation_target_invalid",
    "You cannot start a session as an inactive user.": "errors.superadmin_impersonation_inactive_target",
    ...
    "El motivo de modificación es obligatorio.": "errors.modification_reason_required",
    ...
    "Superadministrators do not have attendance records.": "errors.superadmin_attendance_not_available",
