...
const envSchema = z.object({
  ...
  DATABASE_CONNECTION_LIMIT: z.coerce.number().int().min(1).max(20).optional(),
  JWT_SECRET: z.string().min(16),
  JWT_EXPIRES_IN: z.string().default("12h"),
  CORS_ORIGIN: z.string().default("*"),
  TRUST_PROXY: z.union([z.literal("true"), z.literal("false")]).default("false"),
  JSON_BODY_LIMIT: z.string().default("256kb"),
  API_RATE_LIMIT_WINDOW_MS: z.coerce.number().default(60 * 1000),
  API_RATE_LIMIT_MAX: z.coerce.number().default(240),
